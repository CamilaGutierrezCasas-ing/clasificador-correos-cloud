...
def read_live_microsoft_emails(
    ...
    """
    Consulta correos en vivo desde Microsoft Graph y guarda SOLO metadatos mínimos.

    Se devuelve subject/bodyPreview en la respuesta HTTP para mostrar en pantalla,
...
def update_live_email_category_endpoint(
    ...
    email = update_microsoft_email_correction(
        db,
        owner=current_user,
        account=account,
